...
const Hero = () => {
  return (
    <section className="center flex-col  py-52 space-y-5  md:mx-20 md:pt-20px  h-[100vh] sticky top-0  " >
         <h2 className=" font-main text-[20px] md:text-[34px] lg:text-[52px] mb-2  font-semibold text-black" >Hi, I’m Nanda Kumar M</h2>
         <h1 className="font-main font-bold text-center text-[42px] md:text-[54px] lg:text-[72px] text-black mb leading-[1.1] md:leading-[1.2] " >Full-stack <br className=" sm:hidden" /> web <span className="" >Developer</span></h1>
