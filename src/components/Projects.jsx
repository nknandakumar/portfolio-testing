...
const Projects = () => {
  return (
    <section className="flex flex-col items-center bg-black  pb-20 relative z-20 px-6 lg:px-32">
      ...
      className="section-name pt-20 bg-clip-text text-transparent bg-gradient-to-b from-neutral-200 to-neutral-300">Projects</motion.h2>
      ...
      <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-6 mt-10">
        {[...Array(3)].map((_, index) => (
          <div
            key={index}
            className="w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg bg-white shadow-lg rounded-2xl p-5 group hover:shadow-2xl transition-shadow duration-300 bg-[radial-gradient(circle,#80808040_1px,transparent_1px)] bg-[size:14px_14px]"
          >
            {/* Image Section */}
            ...
            className="text-xl font-main md:text-2xl font-bold text-gray-800 mt-4">
              Agency Landing Page
            </h3>
